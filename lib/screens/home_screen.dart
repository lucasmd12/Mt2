...
import 'package:lucasbeatsfederacao/screens/tabs/home_tab.dart'; // Será o Dashboard Contextual
import 'package:lucasbeatsfederacao/screens/chat/contextual_chat_screen.dart'; // Novo chat contextual
import 'package:lucasbeatsfederacao/screens/voip/contextual_voice_screen.dart'; // Nova tela de voz contextual
import 'package:lucasbeatsfederacao/screens/exploration/federation_explorer_screen.dart'; // Nova tela de exploração
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // Novas telas para as tabs
  static const List<Widget> _widgetOptions = <Widget>[
    HomeTab(), // Dashboard Contextual
    FederationExplorerScreen(), // Explorar
    ContextualChatScreen(chatContext: 'global'), // Chat Global inicial
    ContextualVoiceScreen(voiceContext: 'global'), // Voz Global inicial
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        actions: [
          // Removendo botões de Federações e Salas de Voz do AppBar para integrar na nova navegação
          // O botão de Notificações pode ser mantido ou movido para a tela de Configurações
           IconButton(
